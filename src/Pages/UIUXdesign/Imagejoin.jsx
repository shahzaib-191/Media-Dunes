    ...
    <div ref={containerRef} className="joine-container container">
      <div className="join-texxt-container animate__animated">
        ...
        <h1 className="joining-text">
          We crafted the UI/UX design for Rapid7's Hybrid Exposure Cybersecurity Management System SaaS, taking it from concept to completion.
        </h1>
      </div>
      <div className="image-section animate__animated">
        <img
          src="repurpose-our-work-md.webp" // Replace with your image URL
          alt="Bluemark SaaS"
